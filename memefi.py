...
# HANDLE SHOHAG VAII ERROR TAROH DISINI BANG SAFE_POST
    ...
    while True:
        ...
        for index, result, first_name, last_name, league in accounts:
            ...
            if stat_result is not None:
                ...
                output = (
                    f"[ SHOHAG VAII →{index + 1} - {first_name} {last_name} ]\n"
        ...
        print("=== [ SHOHAG VAII BY PROSESING ] ===")
